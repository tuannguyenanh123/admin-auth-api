...
export class UsersService {
  ...
  async handleRegister(registerUserDto: CreateUserDto) {
    const { name, email, address, password, phone, image } = registerUserDto;
    ...
    this.mailerService
      .sendMail({
        to: user.email,
        subject: 'Active your account at @candydev',
        template: 'register',
        context: {
